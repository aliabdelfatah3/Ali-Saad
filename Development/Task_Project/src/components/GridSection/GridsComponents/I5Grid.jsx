...
function I5Grid({ addToCart }) {
  const [activeColor5, setActiveColor5] = useState("Grey");
  const [isCardVisible5, setIsCardVisible5] = useState(false);
  const [isDropdownOpen5, setIsDropdownOpen5] = useState(false);
  const [selectedSize5, setSelectedSize5] = useState("");
  ...
  const handleAddToCart = () => {
    if (selectedSize5) {
      ...
      setSelectedSize5(""); // Reset selected size
  ...
  return (
    <>
      <div className="lg:w-[433px] md:w-[180px] w-[169px] lg:h-[444px] md:h-[190px] h-[186px] relative">
        ...
        <button
          onClick={toggleCard5}
          className="absolute lg:top-[104px] top-[19px] lg:left-[213px] left-[101px] lg:size-auto size-[16px] "
        >
      ...
      {isCardVisible5 && (
        <div className="fixed inset-0 flex items-center justify-center z-20 bg-black bg-opacity-50">
          <div className="bg-[#F8F8F8] w-[311px] h-[447px] p-4 text-right">
            ...
            {/******************************** Card Content *********************************/}
            <div className="flex">
              <img src={image5} alt="" className="w-[120px] h-[140px]" />
                ...
                <div className="relative flex justify-center w-[271px] mt-1.5">
                  ...
                  <div className="flex w-[100%]">
                    <div className="w-[50%] flex border-[0.5px] border-black">
                      ...
                      <button
                        onClick={() => setActiveColor5("Grey")}
                        className={`relative z-20 w-[100%] py-2 border-black font-Jost ${
                          activeColor5 === "Grey" ? "text-white" : "text-black"
                        }`}
                      >
                        Grey
                      </button>
                    ...
                    <div className="w-[50%] flex border border-black">
                      ...
                      <button
                        onClick={() => setActiveColor5("Black")}
                        className={`relative z-20 w-[100%] py-2 font-Jost ${
                          activeColor5 === "Black" ? "text-white" : "text-black"
                        }`}
                      >
                        Black
                      </button>
