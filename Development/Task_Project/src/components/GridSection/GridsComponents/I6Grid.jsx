...
function I6Grid({ addToCart }) {
  const [activeColor6, setActiveColor6] = useState("Blue");
  const [isCardVisible6, setIsCardVisible6] = useState(false);
  const [isDropdownOpen6, setIsDropdownOpen6] = useState(false);
  const [selectedSize6, setSelectedSize6] = useState("");

  const toggleCard6 = () => {
    setIsCardVisible6(!isCardVisible6);
  };
  ...
  const handleAddToCart = () => {
    if (selectedSize6) {
      ...
      setSelectedSize6(""); // Reset selected size
  ...
  return (
    <>
      <div className="lg:w-[433px] md:w-[180px] w-[169px] lg:h-[444px] md:h-[190px] h-[186px] relative">
        ...
        <button
          onClick={toggleCard6}
          className="absolute lg:top-[164px] top-[19px] lg:left-[320px] left-[101px] lg:size-auto size-[16px] "
        >
                ...
                <div className="relative flex justify-center w-[271px] mt-1.5">
                  ...
                  <div className="flex w-[100%]">
                    <div className="w-[50%] flex border-[0.5px] border-black">
                      ...
                      <button
                        onClick={() => setActiveColor6("Blue")}
                        className={`relative z-20 w-[100%] py-2 border-black font-Jost ${
                          activeColor6 === "Blue" ? "text-white" : "text-black"
                        }`}
                      >
                        Blue
                      </button>
                    ...
                    <div className="w-[50%] flex border border-black">
                      ...
                      <button
                        onClick={() => setActiveColor6("Black")}
                        className={`relative z-20 w-[100%] py-2 font-Jost ${
                          activeColor6 === "Black" ? "text-white" : "text-black"
                        }`}
                      >
                        Black
                      </button>
