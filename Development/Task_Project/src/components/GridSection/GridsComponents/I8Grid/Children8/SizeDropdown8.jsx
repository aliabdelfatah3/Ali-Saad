...
function SizeDropdown8({ selectedSize, setSelectedSize }) {
  ...
  return (
    <div className="mt-2.5">
      ...
      {/* Dropdown button to toggle the dropdown */}
      <button
      ...
      >
        {/* Selected size or default prompt */}
          ...
          <ul>
            ...
            {["XS", "S", "M", "L", "XL"].map((size) => (
              <li
                ...
                onClick={() => {
                  // Set selected size and close dropdown
