...
function I2Grid({ addToCart }) {
  const [activeColor2, setActiveColor2] = useState("Blue");
  ...
  const handleAddToCart = () => {
    if (selectedSize2) {
      ...
      setSelectedSize2(""); // Reset selected size
  ...
  return (
    <>
      <div className="relative lg:w-[433px] md:w-[180px] w-[169px] lg:h-[444px] md:h-[190px] h-[186px] ">
        ...
        <button
          onClick={toggleCard2}
          className="absolute lg:top-[222px] top-[19px] lg:left-[355px] left-[101px] lg:size-auto size-[16px]"
        >
                ...
                <div className="relative flex justify-center w-[271px] mt-1.5">
                  ...
                  <div className="flex w-[100%]">
                    <div className="w-[50%] flex border-[0.5px] border-black">
                      ...
                      <button
                        onClick={() => setActiveColor2("Blue")}
                        className={`relative z-20 w-[100%] py-2 border-black font-Jost ${
                          activeColor2 === "Blue" ? "text-white" : "text-black"
                        }`}
                      >
                        Blue
                      </button>
                    ...
                    <div className="w-[50%] flex border border-black">
                      ...
                      <button
                        onClick={() => setActiveColor2("Black")}
                        className={`relative z-20 w-[100%] py-2 font-Jost ${
                          activeColor2 === "Black" ? "text-white" : "text-black"
                        }`}
                      >
                        Black
                      </button>
            ...
            <div className="mt-2.5">
              ...
              >
                <div className="flex border-r font-Jost text-base border-black h-full items-center w-10/12">
                  {selectedSize2 ? selectedSize2 : "Choose your size"}
                </div>
                <svg
