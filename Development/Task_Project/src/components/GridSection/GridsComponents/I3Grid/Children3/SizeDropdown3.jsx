...
function SizeDropdown3({ selectedSize, setSelectedSize }) {
  ...
  return (
    <div className="mt-2.5">
      ...
      {/* Dropdown button */}
      <button
        onClick={() => setIsDropdownOpen(!isDropdownOpen)} // Toggles the dropdown visibility
